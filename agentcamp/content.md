...
### 3. Exploring cutting-edge models: LLMs, SLMs, local development and more
...
### 2. Build your first agent with Azure AI Agent Service
...
### 3. Building a RAG with PostgreSQL
